...
OUTPUT_BASE=/data/xieyuqiang/story_comprehension/checkpoints_ft_with_cfg
...
python -u run_lm_finetune.lm.cfg.py \
--overwrite_output_dir \
--overwrite_cache \
--task_name ${TASK_NAME} \
--data_dir ${DATA_DIR} \
--train_file ${DATA_DIR}/counterfactual_unsupervised.json \
--model_type gpt2 \
