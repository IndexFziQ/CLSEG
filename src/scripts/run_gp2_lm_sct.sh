...
EPOCH_N=5 # epoch_iter=(70)
SEED=42 # seed_iter=(42 100 512 1024 2019)

TASK_NAME='lmft'
NET_NAME='lm'
M_NAME='gpt2_wrong_v2'

BASE_DIR=/home/yuqiang.xyq/unified-story-level-pretraining/src
DATA_DIR=/data/xieyuqiang/story_comprehension/data
MODEL_PATH=/data/pretrained_models/pytorch-gpt2-large
TK_PATH=/data/pretrained_models/pytorch-gpt2-large

OUTPUT_BASE=/data/xieyuqiang/story_comprehension/checkpoints_ft_with_sct
...
python -u run_lm_finetune.lm.sct.py \
--overwrite_output_dir \
--overwrite_cache \
--task_name ${TASK_NAME} \
--data_dir ${DATA_DIR} \
--train_file ${DATA_DIR}/sct/sct.csv \
--model_type gpt2 \
